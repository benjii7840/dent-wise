          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className='space-y-10'>
              <div className='space-y-6 relative z-20'>
                <div className='inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm'>
